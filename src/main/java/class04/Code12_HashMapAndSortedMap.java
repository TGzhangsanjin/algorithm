...
public class Code12_HashMapAndSortedMap {
    ...
    public static void main(String[] args) {
        ...
        DoubleNode z1 = new DoubleNode(1);
        DoubleNode z2 = new DoubleNode(1);
        HashMap<DoubleNode, String> test2 = new HashMap<>();
        test2.put(z1, "我是z1");
        ...
        HashMap<DoubleNode, String> map2 = new HashMap<>();
        DoubleNode node1 = new DoubleNode(1);
        DoubleNode node2 = node1;
