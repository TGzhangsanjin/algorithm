 ...
 *              (3) 证明：
 *                  a. 根据2.(1) 可以得出 x1.x2 ,把x1和x2看成两个数字，如果x2是k2位，则 x1.x2 可以看成，x1 * n^(k-1) + x2, 把 n^(k-1) 用函数n(k2) 代替
 *                  b. x1.x2 < x2.x1 ==>  x1 * n(k2) + x2 < x2 * n(k1) + x1 ==> x1 * n(k2) < x2 * n(k1) + x1 - x2 两边同时乘以 x3
 *                      ==> x1 * n(k2) * x3 < x3 * x2 * n(k1) + x3 * x1 - x3 * x2
 *                  c. x2.x3 < x3.x2 ==> x2 * n(k3) + x3 < x3 * n(k2) + x2  ==> x2 * n(k3) + x3 - x2 < x3 * n(k2)
 *                      ==>   x3 * n(k2) 两边同时乘以 x1 ==> x1 * x2 * n(k3) + x1 * x3 - x1 * x2 < x3 * n(k2) * x1
 *
 *                      x1 * n(k2) * x3 < x3 * x2 * n(k1) - x3 * x2
 *                      x1 * x2 * n(k3) - x1 * x2 < x3 * n(k2) * x1
 *
